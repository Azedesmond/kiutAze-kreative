...
const ArtClasses: React.FC = () => {
  ...
  return (
    <section id="classes" className="py-20 bg-stone-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-stone-900 mb-4">
            Art <span className="text-amber-600">Classes</span>
          </h2>
        ...
        <div className="bg-white rounded-2xl p-8 mb-16 shadow-lg">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-stone-900 mb-4">My Teaching Approach</h3>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {classTypes.map((classType, index) => (
            ...
            >
              <h3 className="text-xl font-bold text-stone-900 mb-3">{classType.title}</h3>
              ...
              <div className="text-center">
                ...
                <button className="w-full bg-amber-600 text-white py-3 rounded-lg font-medium hover:bg-amber-700 transition-colors duration-200">
                  Learn More
                </button>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <h3 className="text-2xl font-bold text-stone-900 mb-8 text-center">What Students Say</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="text-center">
                ...
                <p className="text-stone-600 mb-4 italic">"{testimonial.message}"</p>
                <div>
